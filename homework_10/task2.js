...
function fighter(propertiesOfaFighter) {
	var name = propertiesOfaFighter.name;
	var attack = propertiesOfaFighter.attack;
	var hp = propertiesOfaFighter.hp;
	var wins = 0;
	var loses = 0;
